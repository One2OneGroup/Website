                ...
                <div className="space-y-8">
                  <div className="flex gap-4">
                    <div className="w-10 h-10 rounded-lg bg-cyan-500/[0.06] border border-cyan-500/10 flex items-center justify-center shrink-0">
                      <Phone size={18} className="text-cyan-400/50" />
                    </div>
                    <div>
                      <p className="text-[13px] text-white/30 font-medium mb-1">Phone</p>
                      <p className="text-white text-[15px] font-medium">{companyInfo.phone}</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="w-10 h-10 rounded-lg bg-cyan-500/[0.06] border border-cyan-500/10 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      <p className="text-[13px] text-white/30 font-medium mb-1">Email</p>
                      <p className="text-white text-[15px] font-medium">{companyInfo.email}</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="w-10 h-10 rounded-lg bg-cyan-500/[0.06] border border-cyan-500/10 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      <p className="text-[13px] text-white/30 font-medium mb-1">Office</p>
                      <p className="text-white text-[15px] font-medium leading-relaxed">{companyInfo.address}</p>
                    </div>
                  </div>
                </div>
                ...
                {submitted ? (
                  <div className="glass-card p-12 text-center">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 text-cyan-400/70 text-[14px] font-semibold animated-underline"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid md:grid-cols-2 gap-5">
                      <div>
                        <label className="text-[13px] font-medium text-white/50 mb-2 block">Full Name *</label>
                        ...
                        {errors.fullName && <p className="text-red-400/70 text-[12px] mt-1">{errors.fullName}</p>}
                      </div>
                      <div>
                        <label className="text-[13px] font-medium text-white/50 mb-2 block">Company Name</label>
                    ...
                    <div className="grid md:grid-cols-2 gap-5">
                      <div>
                        <label className="text-[13px] font-medium text-white/50 mb-2 block">Email Address *</label>
                        <input type="email" value={formData.email} onChange={(e) => handleChange('email', e.target.value)}
                          className={`input-futuristic w-full px-4 py-3 rounded-xl text-[14px] ${errors.email ? '!border-red-500/40' : ''}`}
                          placeholder="you@company.com" />
                        {errors.email && <p className="text-red-400/70 text-[12px] mt-1">{errors.email}</p>}
                      </div>
                      <div>
                        <label className="text-[13px] font-medium text-white/50 mb-2 block">Phone Number</label>
                    ...
                    <div>
                      <label className="text-[13px] font-medium text-white/50 mb-2 block">Service Required</label>
                    ...
                    <div>
                      ...
                      {errors.message && <p className="text-red-400/70 text-[12px] mt-1">{errors.message}</p>}
                    </div>

                    {errors.submit && <p className="text-red-400/70 text-[13px] mb-4">{errors.submit}</p>}
